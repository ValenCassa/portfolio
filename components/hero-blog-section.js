      ...
      <Box mb={6}>
        ...
        <BluredBox >
          <Box textAlign={{base: 'center', md: 'left'}}>
            <TextHero >Welcome to my</TextHero>
            <Divider w='100%' pos='absolute' ml='-2.5em' background='#2D323C'/>
            <TextHero >Blog<chakra.span color='#DB6262'>.</chakra.span></TextHero>
            <Divider w='100%' pos='absolute' ml='-2.5em' background='#2D323C' mt='-0.1em'/>
            <Text fontSize='17.5px' fontWeight='300' mt={2}>Here you can find my latest posts!</Text>
          </Box>
